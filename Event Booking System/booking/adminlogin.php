...
<head>
    ...
    <style>
        body{ font: 14px sans-serif;
            ...
            background: linear-gradient(180deg, rgba(255,255,255,0) 36%, rgba(255,145,225,0.4321078773306197) 100%);
         }
...
<body>
    <div class="wrapper">
        <img src ="icons/fireworks1.png" class = "mb-5" style = "width: 20vh">
        <h2 class="fw-bold">EVENT Admin Login</h2>
