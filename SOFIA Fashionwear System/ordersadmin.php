        ...
        <tbody>
            <?php
                ...
                <td style="width: 40vh; text-align:center;vertical-align:middle; <?php if($orderstatus == "PENDING"){echo 'color: #cf550e;';} else if ($orderstatus == "DELIVERED"){echo 'color:green;';} else if ($orderstatus == "CANCELLED"){echo 'color:red;';} ?>"">
                  ...
                  <?php
                    if($orderstatus == "PENDING"){
                        echo '<button style="vertical-align:middle;width: 15vh; margin-top: 5px;" type="button" class="openupModal btn btn-success"  data-toggle="modal" data-target="#successModal";  data-dismiss="modal";>DELIVER</button></a><br>';
                        echo '<button style="vertical-align:middle;width: 15vh; margin-top: 5px;" type="button" class="openupModal btn btn-danger"  data-toggle="modal" data-target="#cancelModal";  data-dismiss="modal";>CANCEL</button></a>';
                    }
                    else if($orderstatus == "DELIVERED"){
                        echo 'ORDER COMPLETE';
                    }
